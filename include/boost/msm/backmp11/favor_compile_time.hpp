...
// using get_rows_of_event_t = mp11::mp_at_c<
...
template<typename Stt, typename Event>
using get_rows_of_event_t = typename get_rows_of_event<Stt, Event>::type;
