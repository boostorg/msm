    ...
    {        
       ...
       constexpr auto stt23_ = R"([*]-> StateA
        ...
        static_assert(std::is_same_v<
            ...
            >
        >);
        //std::cout << "F1:" << by_name("F1") << std::endl;
        //std::cout << "F2:" << by_name("F2") << std::endl;
        //std::cout << "dbg1:" << typeid(stt20).name() << std::endl << std::endl;
        //std::cout << "dbg2:" << typeid(stt21).name() << std::endl;
    }
}
