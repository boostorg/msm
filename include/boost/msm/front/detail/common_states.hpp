...
#ifdef BOOST_MSM_FRONT_DISABLE_STATE_ATTRIBUTES_CONTAINER
#define BOOST_MSM_FRONT_DEFAULT_STATE_ATTRIBUTES_CONTAINER void
#else
#define BOOST_MSM_FRONT_DEFAULT_STATE_ATTRIBUTES_CONTAINER ::boost::fusion::map<>
#endif
...
template <class USERBASE, class Attributes = BOOST_MSM_FRONT_DEFAULT_STATE_ATTRIBUTES_CONTAINER>
